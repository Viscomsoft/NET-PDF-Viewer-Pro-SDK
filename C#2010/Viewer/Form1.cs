...
namespace PDFViewerDemo
{
    public partial class Form1 : Form
    {
        ...
        private void onSaveText(object sender, EventArgs e)
        {
            ...
            uiSaveFileDialog.Filter = "Text Files (*.TXT)|*.TXT";
            if (uiSaveFileDialog.ShowDialog() == System.Windows.Forms.DialogResult.OK)
            {
                
                //_pdf.Document.saveText(uiSaveFileDialog.FileName);
            }
        }
        ...
        {
          //  uncheckViewMenuItems();
          //  uiBookView.Checked = true;
          //  _pdf.View = PDFViewerLib.View.BookView;
        }
        ...
        {
           // FindForm frm = new FindForm(_pdf.TextSearch);
           // frm.StartPageNumber = _pdf.CurrentPage;
           // frm.ShowDialog();
        }
        ...
        private void uiBookView_Click(object sender, EventArgs e)
        {
            ...
            uncheckViewMenuItems();
            uiBookView.Checked = true;
            _pdf.View = Viscomsoft.PDFViewer.View.BookView;
        }
        ...
        {
            uiColorDialog.Color = _pdf.HighlightColor;
            if (uiColorDialog.ShowDialog() == System.Windows.Forms.DialogResult.OK)
                _pdf.HighlightColor = uiColorDialog.Color;
        }
        ...
        private void toolStripMenuItem1_Click(object sender, EventArgs e)
        {
            ...
            else if (frm.iType == 3) // rotate page of pdf
            {
                ...
                if (_pdf.RotatePDF(frm.strRotatePageSource,uiSaveFileDialog.FileName,frm.iRotatePageNo - 1,frm.iRotateAngle))
            ...
            else if (frm.iType == 4) // rotate all pages of pdf
            {
                ...
                if (uiSaveFileDialog.ShowDialog() == System.Windows.Forms.DialogResult.OK)
                {
                    ...
                    if (_pdf.RotatePDFAllPage(frm.strRotatePageSource, uiSaveFileDialog.FileName, frm.iRotateAngle))
            ...
            else if (frm.iType == 5) // crop
            {
                ...
                if (uiSaveFileDialog.ShowDialog() == System.Windows.Forms.DialogResult.OK)
                {
                    ...
                    if (_pdf.CropPDF(frm.strCropSource, frm.iCropLeft, frm.iCropTop,frm.iCropRight,frm.iCropBottom, uiSaveFileDialog.FileName))
            ...
            else if (frm.iType == 6)
            {
                ...
                if (uiSaveFileDialog.ShowDialog() == System.Windows.Forms.DialogResult.OK)
                {
                    ...
                    if (_pdf.MergePDFWithBookmarks(frm.strMergeSource1, frm.strMergeSource2, uiSaveFileDialog.FileName, frm.strMergeRootTitle, frm.strMergeOutline1, frm.strMergeOutline2))
            ...
            else if (frm.iType == 7)
            {
                ...
                if (uiSaveFileDialog.ShowDialog() == System.Windows.Forms.DialogResult.OK)
                {
                    if (_pdf.MaskingPDF(frm.strMaskingSource,uiSaveFileDialog.FileName,frm.iMaskingStartPage,frm.iMaskingEndPage,frm.iMaskingX,frm.iMaskingY,frm.iMaskingWidth,frm.iMaskingHeight,frm.iMaskingR,frm.iMaskingG,frm.iMaskingB))
